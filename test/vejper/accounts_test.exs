defmodule Vejper.AccountsTest do
  use Vejper.DataCase

  alias Vejper.Accounts

  import Vejper.AccountsFixtures
  alias Vejper.Accounts.{User, UserToken}
  ...
  describe "profiles" do
    ...
    @invalid_attrs %{city: nil, profile_image_url: nil, role: nil, username: nil}
    ...
    test "create_profile/1 with valid data creates a profile" do
      valid_attrs = %{city: "some city", profile_image_url: "some profile_image_url", role: "some role", username: "some username"}

      assert {:ok, %Profile{} = profile} = Accounts.create_profile(valid_attrs)
      assert profile.city == "some city"
      assert profile.profile_image_url == "some profile_image_url"
    ...
    test "update_profile/2 with valid data updates the profile" do
      profile = profile_fixture()
      update_attrs = %{city: "some updated city", profile_image_url: "some updated profile_image_url", role: "some updated role", username: "some updated username"}

      assert {:ok, %Profile{} = profile} = Accounts.update_profile(profile, update_attrs)
      assert profile.city == "some updated city"
      assert profile.profile_image_url == "some updated profile_image_url"
